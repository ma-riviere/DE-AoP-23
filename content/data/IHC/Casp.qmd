...
```{r}
casp_shared <- casp_data$clean |>
    pivot_longer(cols = casp_responses, names_to = "Response") |>
    SharedData$new(data = _)
...
function filter_default() {
    document
        .getElementById("resp_filter_casp")
        .getElementsByClassName("selectized")[0]
        .selectize.setValue("A_EGL", false);
    document
        .getElementById("stage_filter_casp")
        .getElementsByClassName("selectized")[0]
        .selectize.setValue("P4", false);
}
...
corr_matrix_plot(
    casp_data$clean,
    vars = c("Condition", "Stage", "Z", casp_responses)
)
```
