...
check_model(
    Dens_Tot_P4_mod,
    check = c("homogeneity", "qq", "reqq", "pp_check"),
    detrend = FALSE
)
```
...
```{r}
Dens_Tot_P4_mod_dharma <- simulateResiduals(
    Dens_Tot_P4_mod,
    plot = FALSE,
    n = 300,
    seed = getOption("seed")
...
ppc_plots(
    Dens_Tot_P4_mod,
    simulations = Dens_Tot_P4_mod_dharma_t,
    term = "Condition",
    is_count = FALSE
)
```
...
outliers <- get_model_based_outliers(
    casp_data$clean,
    Dens_Tot_P4_mod,
    Dens_Tot_P4_mod_dharma,
    casp_responses
)
...
(parameters(
    ...
    effects = "fixed",
    exponentiate = should_exp(Dens_Tot_P4_mod),
    p_adjust = "none",
    include_info = TRUE,
    digits = 3
) |>
...
```{r}
Dens_Tot_P8_mod_dharma <- simulateResiduals(
    Dens_Tot_P8_mod,
    plot = FALSE,
    n = 300,
    seed = getOption("seed")
...
ppc_plots(
    Dens_Tot_P8_mod,
    simulations = Dens_Tot_P8_mod_dharma_t,
    term = "Condition",
    is_count = FALSE
)
```
...
(parameters(
    ...
    component = "conditional",
    effects = "fixed",
    exponentiate = should_exp(Dens_Tot_P8_mod),
    p_adjust = "none",
    include_info = TRUE,
    digits = 3
) |>
...
```{r}
A_EGL_P4_mod_dharma <- simulateResiduals(
    A_EGL_P4_mod,
    plot = FALSE,
    n = 300,
    seed = getOption("seed")
...
ppc_plots(
    A_EGL_P4_mod,
    simulations = A_EGL_P4_mod_dharma_t,
    term = "Condition",
    is_count = FALSE
)
```
...
(parameters(
    ...
    component = "conditional",
    effects = "fixed",
    exponentiate = should_exp(A_EGL_P4_mod),
    p_adjust = "none",
    include_info = TRUE,
    digits = 3
) |>
...
```{r}
A_EGL_P8_mod_dharma <- simulateResiduals(
    A_EGL_P8_mod,
    plot = FALSE,
    n = 300,
    seed = getOption("seed")
...
ppc_plots(
    A_EGL_P8_mod,
    simulations = A_EGL_P8_mod_dharma_t,
    term = "Condition",
    is_count = FALSE
)
```
...
(parameters(
    ...
    component = "conditional",
    effects = "fixed",
    exponentiate = should_exp(A_EGL_P8_mod),
    p_adjust = "none",
    include_info = TRUE,
    digits = 3
) |>
...
```{r}
A_ML_PCL_P4_mod_dharma <- simulateResiduals(
    A_ML_PCL_P4_mod,
    plot = FALSE,
    n = 300,
    seed = getOption("seed")
...
ppc_plots(
    A_ML_PCL_P4_mod,
    simulations = A_ML_PCL_P4_mod_dharma_t,
    term = "Condition",
    is_count = FALSE
)
```
...
(parameters(
    ...
    component = "conditional",
    effects = "fixed",
    exponentiate = should_exp(A_ML_PCL_P4_mod),
    p_adjust = "none",
    include_info = TRUE,
    digits = 3
) |>
...
```{r}
A_ML_PCL_P8_mod_dharma <- simulateResiduals(
    A_ML_PCL_P8_mod,
    plot = FALSE,
    n = 300,
    seed = getOption("seed")
...
ppc_plots(
    A_ML_PCL_P8_mod,
    simulations = A_ML_PCL_P8_mod_dharma_t,
    term = "Condition",
    is_count = FALSE
)
```
...
(parameters(
    ...
    component = "conditional",
    effects = "fixed",
    exponentiate = should_exp(A_ML_PCL_P8_mod),
    p_adjust = "none",
    include_info = TRUE,
    digits = 3
) |>
...
```{r}
A_IGL_P4_mod_dharma <- simulateResiduals(
    A_IGL_P4_mod,
    plot = FALSE,
    n = 300,
    seed = getOption("seed")
...
ppc_plots(
    A_IGL_P4_mod,
    simulations = A_IGL_P4_mod_dharma_t,
    term = "Condition",
    is_count = FALSE
)
```
...
(parameters(
    ...
    component = "conditional",
    effects = "fixed",
    exponentiate = should_exp(A_IGL_P4_mod),
    p_adjust = "none",
    include_info = TRUE,
    digits = 3
) |>
...
```{r}
A_IGL_P8_mod_dharma <- simulateResiduals(
    A_IGL_P8_mod,
    plot = FALSE,
    n = 300,
    seed = getOption("seed")
...
ppc_plots(
    A_IGL_P8_mod,
    simulations = A_IGL_P8_mod_dharma_t,
    term = "Condition",
    is_count = FALSE
)
```
...
(parameters(
    ...
    component = "conditional",
    effects = "fixed",
    exponentiate = should_exp(A_IGL_P8_mod),
    p_adjust = "none",
    include_info = TRUE,
    digits = 3
) |>
...
```{r}
A_WM_P4_mod_dharma <- simulateResiduals(
    A_WM_P4_mod,
    plot = FALSE,
    n = 300,
    seed = getOption("seed")
...
ppc_plots(
    A_WM_P4_mod,
    simulations = A_WM_P4_mod_dharma_t,
    term = "Condition",
    is_count = FALSE
)
```
...
(parameters(
    ...
    component = "conditional",
    effects = "fixed",
    exponentiate = should_exp(A_WM_P4_mod),
    p_adjust = "none",
    include_info = TRUE,
    digits = 3
) |>
...
```{r}
A_WM_P8_mod_dharma <- simulateResiduals(
    A_WM_P8_mod,
    plot = FALSE,
    n = 300,
    seed = getOption("seed")
...
ppc_plots(
    A_WM_P8_mod,
    simulations = A_WM_P8_mod_dharma_t,
    term = "Condition",
    is_count = FALSE
)
```
...
(parameters(
    ...
    component = "conditional",
    effects = "fixed",
    exponentiate = should_exp(A_WM_P8_mod),
    p_adjust = "none",
    include_info = TRUE,
    digits = 3
) |>
